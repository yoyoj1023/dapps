...
export const ProgressIndicator: React.FC<ProgressIndicatorProps> = ({ currentStep, progress, error }) => {
          ...
          return (
            <div key={step.key} className="flex flex-col items-center">
              ...
              <div className="text-xs text-center">
                <div>{step.icon}</div>
                <div className={status === "active" ? "text-blue-600 font-medium" : "text-gray-600"}>{step.label}</div>
              </div>
