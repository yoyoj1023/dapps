  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {/* 留言內容 */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">留言內容 *</label>
          <textarea
            value={formData.text}
          ...
          />
          <div className="text-right text-sm text-gray-500">{formData.text.length} / 5000</div>
        </div>

        {/* 作者名稱 */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">作者名稱 (可選)</label>
          <input
            type="text"
        ...
        {/* 標題 */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">標題 (可選)</label>
          <input
            type="text"
        ...
        {/* 標籤 */}
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">標籤 (可選)</label>
          <input
            type="text"
            value={formData.tags}
            ...
            disabled={state.isPosting}
          />
          <div className="text-sm text-gray-500">用逗號分雔多個標籤</div>
        </div>

        {/* 進度指示器 */}
        <ProgressIndicator currentStep={state.currentStep} progress={state.progress} error={state.error} />
